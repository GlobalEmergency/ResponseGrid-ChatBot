...
> **English:** consulta [`README.md`](README.md) para la versión en inglés.

Asistente multicanal de **Telegram + WhatsApp** que permite operar la plataforma
de ayuda humanitaria [ResponseGrid](https://responsegrid.app) en lenguaje natural
—por texto o nota de voz— desde las apps de chat que la gente ya usa.
...
**Prueba los bots en vivo:** [Telegram](https://t.me/donacionesvenezuela_bot) ·
[WhatsApp](https://wa.me/15559386039) · [App web](https://responsegrid.app)
...
> **¿Quieres contribuir?** Empieza por [`CONTRIBUTING.md`](CONTRIBUTING.md) y las [_good first issues_](https://github.com/GlobalEmergency/ResponseGrid-ChatBot/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22). Publicado bajo [AGPL-3.0](LICENSE).
